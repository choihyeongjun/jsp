...
<div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas id="myAreaChart" width="434" height="173" style="display: block; width: 434px; height: 173px;" class="chartjs-render-monitor"></canvas></div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas id="myBarChart" width="434" height="173" class="chartjs-render-monitor" style="display: block; width: 434px; height: 173px;"></canvas></div>
                                </div>
                            </div>
                        </div>
</body>
